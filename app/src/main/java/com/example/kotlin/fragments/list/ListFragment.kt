...
import com.example.kotlin.utils.GenerateDummyTask
...
//        recyclerView.layoutManager = LinearLayoutManager(requireActivity())
        recyclerView.layoutManager = StaggeredGridLayoutManager(resources.getInteger(R.integer.span_count),StaggeredGridLayoutManager.VERTICAL)
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        when(item.itemId){
            ...
            R.id.generate_dummytext -> GenerateDummyTask(mTodoViewModel).generateDummyTask()
        }
